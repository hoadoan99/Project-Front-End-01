            ...
            <div class="col-xs-12 col-sm-8">
              <ul class="header-top-right text-right">
                ...
                <li class="language dropdown"> <span class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button">Language <span class="caret"></span> </span>
                 ...
                 <li><a href="#"><img  style="width: 15%;" src="flag/vietnam.svg" alt="">Tiếng Việt</a></li>
                 <li><a href="#"><img  style="width: 15%;"src="flag/france.svg" alt="">French</a></li>
                 <li><a href="#"><img  style="width: 15%;"src="flag/germany.svg" alt="">German</a></li>
                 <li><a href="#"><img  style="width: 15%;"src="flag/south-korea.svg" alt="">Korea</a></li>
                 <li><a href="#"><img  style="width: 15%;"src="flag/japan.svg" alt="">Japan</a></li>
